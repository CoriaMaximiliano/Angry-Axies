(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "index.btn.apk": "Get it on Google Play",
      ...
      "download.install.1":
        "Download <code>AngryAxies-1.142.apk</code> on your phone (Chrome, Drive, USB, etc.).",
      "download.install.2":
    ...
    es: {
      ...
      "index.btn.iphone": "iPhone",
      "index.btn.apk": "Descargar en Google Play",
      ...
      "download.install.1":
        "Descargá <code>AngryAxies-1.142.apk</code> en el teléfono (Chrome, Drive, USB, etc.).",
      "download.install.2":
    ...
    fil: {
      ...
      "index.btn.iphone": "iPhone",
      "index.btn.apk": "I-download sa Google Play",
      ...
      "download.install.1":
        "I-download ang <code>AngryAxies-1.142.apk</code> sa telepono (Chrome, Drive, USB, atbp.).",
      "download.install.2":
    ...
    zh: {
      ...
      "index.btn.iphone": "iPhone",
      "index.btn.apk": "在 Google Play 下载",
      ...
      "download.install.1":
        "在手机上下载 <code>AngryAxies-1.142.apk</code>（Chrome、Drive、USB 等）。",
      "download.install.2":
