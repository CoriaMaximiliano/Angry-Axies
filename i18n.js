(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "download.intro":
        "The official download for the current build is on GitHub, in release <strong>1.134</strong>. Open the release page and download the APK from Assets.",
      "download.btn.release": "Open release 1.134 on GitHub",
      "download.direct.label": "<strong>Direct download for this version (1.134):</strong>",
      "download.latest":
      ...
      "download.install.1":
        "Download <code>AngryAxies-1.134.apk</code> on your phone (Chrome, Drive, USB, etc.).",
      "download.install.2":
    ...
    es: {
      ...
      "download.intro":
        "La descarga oficial del build actual está en GitHub, en la release <strong>1.134</strong>. Abrí la página del release y descargá el APK desde «Assets».",
      "download.btn.release": "Abrir release 1.134 en GitHub",
      "download.direct.label": "<strong>Descarga directa de esta versión (1.134):</strong>",
      "download.latest":
      ...
      "download.install.1":
        "Descargá <code>AngryAxies-1.134.apk</code> en el teléfono (Chrome, Drive, USB, etc.).",
      "download.install.2":
    ...
    fil: {
      ...
      "download.intro":
        "Ang opisyal na download ng kasalukuyang build ay nasa GitHub, sa release na <strong>1.134</strong>. Buksan ang release page at i-download ang APK mula sa Assets.",
      "download.btn.release": "Buksan ang release 1.134 sa GitHub",
      "download.direct.label": "<strong>Direktang download para sa bersyong ito (1.134):</strong>",
      "download.latest":
      ...
      "download.install.1":
        "I-download ang <code>AngryAxies-1.134.apk</code> sa telepono (Chrome, Drive, USB, atbp.).",
      "download.install.2":
    ...
    zh: {
      ...
      "download.intro":
        "当前版本的官方下载在 GitHub 上，标签为 <strong>1.134</strong> 的 release。打开 release 页面，从 Assets 下载 APK。",
      "download.btn.release": "在 GitHub 打开 1.134 release",
      "download.direct.label": "<strong>此版本（1.134）直接下载：</strong>",
      "download.latest":
      ...
      "download.install.1":
        "在手机上下载 <code>AngryAxies-1.134.apk</code>（Chrome、Drive、USB 等）。",
      "download.install.2":
